...
Describe "Integration Tests PS$PSVersion" -tag 'Integration' {
    ...
    BeforeAll {
        ...
        # Show-XKCDExplanation writes the rendered explanation straight to the console; running it here
    ...
    Context 'Default Comic Tests' {
        ...
        It 'Show-XKCDExplanation displays the latest comic without throwing' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation } } | Should -Not -Throw
        }

        It 'Show-XKCDExplanation does not return an object to the pipeline' {
            Get-XKCDCapturedOutput { $script:Result = Show-XKCDExplanation } | Out-Null
    ...
    Context 'Specific Comic Tests' {
        ...
        It 'Show-XKCDExplanation accepts pipeline input of comic numbers' {
            { Get-XKCDCapturedOutput { 1, 2000 | Show-XKCDExplanation } } | Should -Not -Throw
        }
    ...
    Context 'High Quality Tests' {
        ...
        It 'Show-XKCDExplanation -HighQuality displays the larger _2x image when available' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation -Num 3290 -HighQuality } } | Should -Not -Throw
        }
        ...
        It 'Show-XKCDExplanation -HighQuality falls back to standard quality when no _2x image is available' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation -Num 1 -HighQuality -WarningAction SilentlyContinue } } | Should -Not -Throw
        }
    }
    ...
    Context 'Section Tests' {
        ...
        It 'Show-XKCDExplanation -Transcript does not throw' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation -Num 2000 -Transcript } } | Should -Not -Throw
        }

        It 'Show-XKCDExplanation -Discussion does not throw' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation -Num 2000 -Discussion } } | Should -Not -Throw
        }

        It 'Show-XKCDExplanation -Full does not throw' {
            { Get-XKCDCapturedOutput { Show-XKCDExplanation -Num 2000 -Full } } | Should -Not -Throw
        }
    }
    ...
    Context 'Missing Page Tests' {
        ...
        It 'Show-XKCDExplanation warns and displays nothing for a comic with no explainxkcd page' {
            Get-XKCDCapturedOutput { $script:Result = Show-XKCDExplanation -Num 99999999 -WarningAction SilentlyContinue -WarningVariable 'script:Warnings' } | Out-Null
