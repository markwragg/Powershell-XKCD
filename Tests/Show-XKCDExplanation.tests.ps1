...
Describe "Unit Tests PS$PSVersion" {
    ...
    Context 'Comic Display Tests' {
        ...
        It 'Fetches and displays the comic image by default' {
            ...
            Assert-MockCalled -ModuleName $Module Get-XKCD -Times 1 -Exactly -Scope It
            Assert-MockCalled -ModuleName $Module Show-XKCDImage -Times 1 -Exactly -Scope It
        }
        ...
        It '-Explanation does not fetch or display the comic image' {
            ...
            Assert-MockCalled -ModuleName $Module Get-XKCD -Times 0 -Exactly -Scope It
            Assert-MockCalled -ModuleName $Module Show-XKCDImage -Times 0 -Exactly -Scope It
        }
